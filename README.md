...
frontend application. Drop this folder into its own Git repo and deploy it on
...
`artifacts/api-server`. The frontend application works against this backend
...
| `CORS_ORIGIN`  | Your admin URL, e.g. `https://your-frontend-domain.com` (or `*`)  |
